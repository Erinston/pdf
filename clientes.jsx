   ...
   // const marc_D_agua =  'Tascom Tecnologia';
    ...
    const dados = clientes.map((cliente) => {
            ...
            return [
                ...
                {text: cliente.convenio, fontSize: 9, margin: [0, 1, 0, 1]},
                {text: cliente.service, fontSize: 9,alignment: 'center', margin: [0, 1, 0, 1]},
    ...
    const details = [
        {
            table:{
                style:'tableExample',
                headerRows: 1,
                widths: [40, 70, 100, 100, 65,50,70 ],
                
                body: [
                   
                    [
                        {text: 'Atend.', style: 'tableHeader', fontSize: 11 , border:[false,false,false,true]},
                        ...
                        {text: 'Convênio ', style: 'tableHeader', fontSize: 11,border:[false,false,false,true]},
                        {text: 'Serviço  ', style: 'tableHeader', fontSize: 11,alignment: 'center',border:[false,false,false,true]},
